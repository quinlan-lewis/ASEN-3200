...
BEGIN Scenario
    ...
    BEGIN Interval
        ...
        Stop		 2 Jan 2020 00:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jan 2020 00:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 25380000
            LaunchWindowStop		 25380000
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 20 Oct 2020 18:00:00.000000000
                    Stop		 21 Oct 2020 18:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            BEGIN LongText
Lab 1, starting jan 1st and ending 1 day later
            END LongText
        END Desc
    ...
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                EndTime		 2 Jan 2020 00:00:00.000000000
                CurrentTime		 4 Jan 2020 08:50:00.000000000
                Direction		 Forward
                UpdateDelta		 600
